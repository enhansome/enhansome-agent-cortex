...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 388,969 | 🐛 6,250 | 🌐 TypeScript | 📅 2026-09-05 - Self-hosted personal AI agent with multi-platform messaging and skill registry.
* [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 241,967 | 🐛 40,020 | 🌐 Python | 📅 2026-09-05 - Tool-using autonomous agent platform with memory, skills, delegation, and MCP support.
* [LangChain](https://github.com/langchain-ai/langchain) ⭐ 145,711 | 🐛 453 | 🌐 Python | 📅 2026-09-05 - Composable framework for building LLM-powered applications.
* [AutoGen](https://github.com/microsoft/autogen) ⭐ 60,821 | 🐛 1,048 | 🌐 Python | 📅 2026-04-15 - Multi-agent conversation framework from Microsoft Research.
* [Magentic-One](https://github.com/microsoft/autogen/tree/main/python/packages/autogen-magentic-one) ⭐ 60,821 | 🐛 1,048 | 🌐 Python | 📅 2026-04-15 - Multi-agent team for complex web and file tasks.
* [CrewAI](https://github.com/crewAIInc/crewAI) ⭐ 58,121 | 🐛 741 | 🌐 Python | 📅 2026-09-04 - Role-based multi-agent orchestration framework.
* [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 52,030 | 🐛 705 | 🌐 Python | 📅 2026-09-05 - Data framework for document agents, retrieval, and workflow orchestration.
* [Agno](https://github.com/agno-agi/agno) ⭐ 42,066 | 🐛 1,346 | 🌐 Python | 📅 2026-09-05 - Framework for building and running agentic software at scale.
* [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 41,101 | 🐛 750 | 🌐 Python | 📅 2026-09-03 - Library for building stateful multi-agent workflows as graphs.
* [OpenAI Agents SDK for Python](https://github.com/openai/openai-agents-python) ⭐ 29,211 | 🐛 68 | 🌐 Python | 📅 2026-09-05 - Official Python SDK for agent workflows, tools, handoffs, and guardrails.
* [Smolagents](https://github.com/huggingface/smolagents) ⭐ 29,172 | 🐛 781 | 🌐 Python | 📅 2026-08-25 - Lightweight agent framework from Hugging Face.
* [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,537 | 🐛 282 | 🌐 C# | 📅 2026-09-04 - SDK for integrating LLMs into apps with plugin architecture.
* [Mastra](https://github.com/mastra-ai/mastra) ⭐ 27,725 | 🐛 528 | 🌐 TypeScript | 📅 2026-09-05 - TypeScript framework for building AI applications and agents.
* [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,425 | 🐛 120 | 🌐 Python | 📅 2026-09-04 - LLM orchestration framework for building search and RAG pipelines.
* [Letta](https://github.com/letta-ai/letta) ⭐ 24,624 | 🐛 39 | 📅 2026-08-23 - Stateful agents with long-term memory (formerly MemGPT).
* [Swarm](https://github.com/openai/swarm) ⭐ 21,943 | 🐛 35 | 🌐 Python | 📅 2026-04-15 - Educational framework for multi-agent handoffs and routines.
* [Google ADK](https://github.com/google/adk-python) ⭐ 21,420 | 🐛 502 | 🌐 Python | 📅 2026-09-05 - Agent Development Kit for building agents with Gemini.
* [PydanticAI](https://github.com/pydantic/pydantic-ai) ⭐ 19,741 | 🐛 820 | 🌐 Python | 📅 2026-09-05 - Type-safe agent framework built around Pydantic.
* [ElizaOS](https://github.com/elizaOS/eliza) ⭐ 19,258 | 🐛 1,334 | 🌐 TypeScript | 📅 2026-09-05 - Multi-agent simulation framework for autonomous characters.
* [Microsoft Agent Framework](https://github.com/microsoft/agent-framework) ⭐ 13,345 | 🐛 639 | 🌐 Python | 📅 2026-09-05 - Framework for building, orchestrating, and deploying agents with Python and .NET support.
* [Rig](https://github.com/0xPlaygrounds/rig) ⭐ 8,531 | 🐛 112 | 🌐 Rust | 📅 2026-09-05 - Rust framework for building LLM-powered applications.
* [Claude Agent SDK](https://github.com/anthropics/claude-agent-sdk-python) ⭐ 8,038 | 🐛 448 | 🌐 Python | 📅 2026-09-04 - Official Python SDK for building agents on the Claude Code runtime.
...
* [AG2](https://github.com/ag2ai/ag2) ⭐ 4,904 | 🐛 29 | 🌐 Python | 📅 2026-09-05 - Open-source AgentOS for building multi-agent systems (evolved from AutoGen).
* [OpenAI Agents SDK for TypeScript](https://github.com/openai/openai-agents-js) ⭐ 3,756 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-05 - Official TypeScript SDK for agent workflows and voice agents.
...
* [fractal](https://github.com/plasma-ai/fractal) ⭐ 713 | 🐛 4 | 🌐 Python | 📅 2026-09-05 - Runs supported coding-agent CLIs as a recursive hierarchy with per-node Git worktrees, configurable limits, persistent run state, and a live terminal UI.
* [OpenProgram](https://github.com/Fzkuji/OpenProgram) ⭐ 384 | 🐛 1 | 🌐 Python | 📅 2026-09-05 - Self-programming agent runtime with reviewable workflows, DAG context, tools, memory, and multi-agent execution.
* [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 53 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-05 - Self-hosted platform to run a team of specialized AI agents with persistent memory, a web UI, and chat channels.

## Coding Agents

AI agents that write, review, and debug code.

* [Codex CLI](https://github.com/openai/codex) ⭐ 121,739 | 🐛 15,453 | 🌐 Rust | 📅 2026-09-05 - OpenAI's open-source coding agent for terminal workflows.
* [OpenHands](https://github.com/OpenHands/OpenHands) ⭐ 86,266 | 🐛 662 | 🌐 TypeScript | 📅 2026-09-05 - Platform for AI software development agents (formerly OpenDevin).
* [Cline](https://github.com/cline/cline) ⭐ 67,524 | 🐛 1,250 | 🌐 TypeScript | 📅 2026-09-05 - Autonomous coding agent for VS Code with tool use.
* [Goose](https://github.com/aaif-goose/goose) ⭐ 53,940 | 🐛 304 | 🌐 Rust | 📅 2026-09-05 - Open-source developer agent governed by the Agentic AI Foundation.
* [Aider](https://github.com/Aider-AI/aider) ⭐ 48,774 | 🐛 1,853 | 🌐 Python | 📅 2026-05-22 - AI pair programming in the terminal with git integration.
* [Continue](https://github.com/continuedev/continue) ⭐ 35,779 | 🐛 944 | 🌐 TypeScript | 📅 2026-09-04 - Open-source AI code assistant for VS Code and JetBrains.
* [SWE-Agent](https://github.com/SWE-agent/SWE-agent) ⭐ 20,240 | 🐛 98 | 🌐 Python | 📅 2026-08-31 - Agent for resolving software engineering tasks from GitHub issues.
...
* [Everything Claude Code](https://github.com/affaan-m/ECC) ⭐ 249,791 | 🐛 147 | 🌐 JavaScript | 📅 2026-09-05 - Community collection of Claude Code skills, hooks, agents, and configuration patterns.
* [awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) ⭐ 53,562 | 🐛 994 | 🌐 Python | 📅 2026-09-05 - Curated list of Claude Code resources.
* [claude-code-tips](https://github.com/ykdojo/claude-code-tips) ⭐ 10,040 | 🐛 4 | 🌐 HTML | 📅 2026-09-02 - Community-sourced tips and tricks.
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,524 | 🐛 145 | 🌐 Python | 📅 2026-08-31 - Open-source speech recognition model from OpenAI.
* [Pipecat](https://github.com/pipecat-ai/pipecat) ⭐ 15,246 | 🐛 308 | 🌐 Python | 📅 2026-09-05 - Framework for building voice and multimodal conversational agents.
* [LiveKit Agents](https://github.com/livekit/agents) ⭐ 14,024 | 🐛 785 | 🌐 Python | 📅 2026-09-05 - Framework for building real-time multimodal AI agents.
* [TEN Framework](https://github.com/TEN-framework/ten-framework) ⭐ 11,109 | 🐛 234 | 🌐 Python | 📅 2026-09-04 - Open-source framework for conversational voice AI agents.
...
* [ElevenLabs](https://github.com/elevenlabs/elevenlabs-python) ⭐ 3,086 | 🐛 36 | 🌐 Python | 📅 2026-09-03 - Text-to-speech and voice cloning API for agent voice interfaces.
...
* [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 241,967 | 🐛 40,020 | 🌐 Python | 📅 2026-09-05 - Open-source autonomous AI agent with CLI, gateway, memory, subagents, and broad tool integrations.
* [Hermes Agent Self-Evolution](https://github.com/NousResearch/hermes-agent-self-evolution) ⭐ 5,257 | 🐛 121 | 🌐 Python | 📅 2026-06-17 - Evolutionary self-improvement framework for optimizing Hermes Agent prompts, skills, and code.
* [Hermes Paperclip Adapter](https://github.com/NousResearch/hermes-paperclip-adapter) ⭐ 1,860 | 🐛 148 | 🌐 TypeScript | 📅 2026-04-04 - Adapter for running Hermes Agent as a managed employee inside Paperclip.
...
* [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 241,967 | 🐛 40,020 | 🌐 Python | 📅 2026-09-05 - CLI and gateway agent runtime with tools, memory, delegation, and automation support.
* [Codex CLI](https://github.com/openai/codex) ⭐ 121,739 | 🐛 15,453 | 🌐 Rust | 📅 2026-09-05 - Open-source coding agent from OpenAI.
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,821 | 🐛 849 | 🌐 TypeScript | 📅 2026-09-05 - Google's command-line interface for Gemini models.
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,029 | 🐛 1,025 | 🌐 Go | 📅 2026-09-05 - Terminal UI for git commonly paired with coding agents.
* [tmux](https://github.com/tmux/tmux) ⭐ 49,078 | 🐛 31 | 🌐 C | 📅 2026-09-05 - Terminal multiplexer for running agents in persistent sessions.
* [Zellij](https://github.com/zellij-org/zellij) ⭐ 35,291 | 🐛 1,898 | 🌐 Rust | 📅 2026-08-31 - Terminal workspace with plugin system for agent integration.
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,197 | 🐛 230 | 🌐 Go | 📅 2026-09-02 - Terminal Markdown renderer useful for agent output.
* [llm](https://github.com/simonw/llm) ⭐ 12,468 | 🐛 684 | 🌐 Python | 📅 2026-09-02 - CLI tool for interacting with LLMs from the terminal.
...
* [Daytona](https://github.com/daytonaio/daytona) ⭐ 71,786 | 🐛 453 | 📅 2026-07-24 - Secure and elastic runtime infrastructure for AI-generated code execution.
* [Firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,555 | 🐛 103 | 🌐 Rust | 📅 2026-09-04 - Secure and fast microVM technology for isolated agent execution.
* [NemoClaw](https://github.com/NVIDIA/NemoClaw) ⭐ 22,377 | 🐛 617 | 🌐 TypeScript | 📅 2026-09-05 - NVIDIA tooling for running OpenClaw inside an OpenShell sandbox with managed inference.
* [CUA](https://github.com/trycua/cua) ⭐ 22,234 | 🐛 799 | 🌐 HTML | 📅 2026-09-05 - Open-source infrastructure for computer-use agents with sandboxes, SDKs, and benchmarks.
* [gVisor](https://github.com/google/gvisor) ⭐ 19,237 | 🐛 872 | 🌐 Go | 📅 2026-09-05 - Application kernel for containers that adds a strong isolation boundary.
* [E2B](https://github.com/e2b-dev/E2B) ⭐ 13,680 | 🐛 52 | 🌐 Python | 📅 2026-09-04 - Open-source secure cloud sandbox environment for AI agents.
* [Kata Containers](https://github.com/kata-containers/kata-containers) ⭐ 8,666 | 🐛 1,182 | 🌐 Rust | 📅 2026-09-05 - Lightweight VM-based container runtime for stronger workload isolation.
...
* [Awesome MCP Servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 94,319 | 🐛 3,942 | 📅 2026-09-01 - Curated list of MCP server implementations.
* [MCP Reference Servers](https://github.com/modelcontextprotocol/servers) ⭐ 90,100 | 🐛 485 | 🌐 TypeScript | 📅 2026-09-03 - Official reference implementations for Model Context Protocol servers.
* [Context7 MCP](https://github.com/upstash/context7) ⭐ 61,670 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-04 - MCP server that retrieves current, version-specific library documentation.
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 51,054 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-04 - Official Chrome DevTools MCP server for coding and browser automation agents.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,832 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04 - MCP server for browser automation via Playwright.
* [GitHub MCP Server](https://github.com/github/github-mcp-server) ⭐ 32,737 | 🐛 311 | 🌐 Go | 📅 2026-09-05 - Official MCP server for GitHub workflows and repository actions.
* [FastMCP](https://github.com/PrefectHQ/fastmcp) ⭐ 27,537 | 🐛 303 | 🌐 Python | 📅 2026-09-05 - Pythonic framework for building MCP servers and clients quickly.
* [Agent2Agent (A2A)](https://github.com/a2aproject/A2A) ⭐ 25,644 | 🐛 244 | 🌐 Shell | 📅 2026-09-04 - Linux Foundation protocol for communication between independent agent applications.
* [MCP Python SDK](https://github.com/modelcontextprotocol/python-sdk) ⭐ 24,210 | 🐛 390 | 🌐 Python | 📅 2026-09-05 - Official Python SDK for building MCP servers.
* [MCP for Beginners](https://github.com/microsoft/mcp-for-beginners) ⭐ 17,159 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-03 - Cross-language curriculum and practical examples for learning MCP.
* [AG-UI](https://github.com/ag-ui-protocol/ag-ui) ⭐ 15,738 | 🐛 343 | 🌐 Python | 📅 2026-09-04 - Event-based protocol for connecting agent backends to interactive user interfaces.
* [MCP TypeScript SDK](https://github.com/modelcontextprotocol/typescript-sdk) ⭐ 13,332 | 🐛 595 | 🌐 TypeScript | 📅 2026-09-05 - Official TypeScript SDK for building MCP servers.
* [MCP Inspector](https://github.com/modelcontextprotocol/inspector) ⭐ 10,830 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-05 - Official inspector and debugging tool for MCP servers.
* [MCP Specification Repo](https://github.com/modelcontextprotocol/modelcontextprotocol) ⭐ 9,143 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-04 - Canonical specification and documentation repository.
* [MCP Go SDK](https://github.com/mark3labs/mcp-go) ⭐ 9,076 | 🐛 33 | 🌐 Go | 📅 2026-09-02 - Go implementation of the Model Context Protocol.
...
* [MCP Registry](https://github.com/modelcontextprotocol/registry) ⭐ 7,223 | 🐛 150 | 🌐 Go | 📅 2026-09-05 - Community registry service for discovering MCP servers.
* [Agent Client Protocol](https://github.com/zed-industries/agent-client-protocol) ⭐ 4,161 | 🐛 42 | 🌐 Rust | 📅 2026-09-05 - Open protocol between coding agents and editors or IDEs.
* [MCP Rust SDK](https://github.com/modelcontextprotocol/rust-sdk) ⭐ 3,883 | 🐛 59 | 🌐 Rust | 📅 2026-09-04 - Official Rust SDK for building MCP servers.
* [SandBase CLI](https://github.com/sandbaseai/cli) ⭐ 113 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-28 - Open-source CLI and local MCP server that configures 25 AI clients for access to 2,000+ models and APIs, with six tools for discovery, execution, run history, and account status.
* [Hexis](https://github.com/Bevel-Software/Hexis) ⭐ 84 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-05 - Git-backed platform for managing skills, tools, and context for AI agents, with review workflows, role-based access, and a remote MCP server.
...
* [awesome-chatgpt-prompts](https://github.com/f/prompts.chat) ⭐ 169,418 | 🐛 74 | 🌐 HTML | 📅 2026-09-05 - Collection of prompt examples for ChatGPT.
* [fabric](https://github.com/danielmiessler/fabric) ⭐ 43,834 | 🐛 68 | 🌐 Go | 📅 2026-09-03 - Framework for augmenting humans using AI with curated prompts.
* [DSPy](https://github.com/stanfordnlp/dspy) ⭐ 37,794 | 🐛 651 | 🌐 Python | 📅 2026-09-05 - Framework for programming with foundation models instead of prompting.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,845 | 🐛 577 | 🌐 TypeScript | 📅 2026-09-05 - Testing and evaluation framework for LLM prompts.
...
* [browser-use](https://github.com/browser-use/browser-use) ⭐ 112,392 | 🐛 391 | 🌐 Python | 📅 2026-09-05 - Framework for browser task automation and agent web interaction loops.

* [AutoGen agbench](https://github.com/microsoft/autogen/blob/main/python/packages/agbench/README.md) ⭐ 60,821 | 🐛 1,048 | 🌐 Python | 📅 2026-04-15 - Benchmark runner for AutoGen agent workflows.

* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,152 | 🐛 348 | 🌐 TypeScript | 📅 2026-09-05 - Browser automation framework for agentic web workflows and reproducible runs.

* [SWE-bench](https://github.com/SWE-bench/SWE-bench) ⭐ 5,781 | 🐛 10 | 🌐 Python | 📅 2026-09-02 - Canonical benchmark for coding agents on real GitHub issue tasks.
...
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,709 | 🐛 270 | 🌐 Python | 📅 2026-09-05 - Open-source framework for reproducible LLM and agent evaluations.
...
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,601 | 🐛 103 | 🌐 Python | 📅 2025-11-26 - Real-world web task benchmark environment for browser agents.

* [Tau-Bench](https://github.com/sierra-research/tau-bench) ⭐ 1,423 | 🐛 53 | 🌐 Python | 📅 2026-03-18 - Realistic interactive benchmark for measuring agent reliability.
...
* [AgentDojo](https://github.com/ethz-spylab/agentdojo) ⭐ 803 | 🐛 51 | 🌐 Python | 📅 2026-06-02 - Security and robustness benchmark suite for tool-using agents.
...
* [ClawBench](https://github.com/TIGER-AI-Lab/ClawBench) ⭐ 651 | 🐛 52 | 🌐 Python | 📅 2026-09-05 - Browser-agent benchmark with 283 tasks (V1 153 + V2 130) across 163 live websites, safe final-action interception, and replay, action, network, and message traces.
...
* [12-Factor Agents](https://github.com/humanlayer/12-factor-agents) ⭐ 25,712 | 🐛 27 | 🌐 TypeScript | 📅 2025-09-21 - Engineering principles for building reliable, production-grade LLM agents.
...
* [Obsidian Git](https://github.com/Vinzent03/obsidian-git) ⭐ 11,915 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-17 - Versioned vault operations for auditable agent writes.
* [Dataview](https://github.com/blacksmithgu/obsidian-dataview) ⭐ 9,321 | 🐛 663 | 🌐 TypeScript | 📅 2025-11-17 - Query engine for structured note metadata and graph-aware retrieval.
* [Local REST API Plugin](https://github.com/coddingtonbear/obsidian-local-rest-api) ⭐ 2,894 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - Local HTTP interface for external agent integrations.
...
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,845 | 🐛 577 | 🌐 TypeScript | 📅 2026-09-05 - Red-teaming and robustness testing toolkit for LLM systems.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,119 | 🐛 417 | 🌐 Python | 📅 2026-09-04 - LLM vulnerability scanning and red-teaming toolkit for security testing.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,358 | 🐛 82 | 🌐 Python | 📅 2026-09-04 - Validation and safety guardrails framework for LLM outputs.
* [NeMo Guardrails](https://github.com/NVIDIA-NeMo/Guardrails) ⭐ 7,069 | 🐛 217 | 🌐 Python | 📅 2026-09-04 - Toolkit for adding programmable safety and policy guardrails to LLM systems.
...
* [PyRIT](https://github.com/microsoft/PyRIT) ⭐ 4,407 | 🐛 111 | 🌐 Python | 📅 2026-09-04 - Python Risk Identification Tool for testing generative AI systems.
...
* [awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) ⭐ 40,728 | 🐛 59 | 🌐 JavaScript | 📅 2026-05-30 - Curated list of Cursor rule files.
...
* [anthropics/skills](https://github.com/anthropics/skills) ⭐ 174,534 | 🐛 1,208 | 🌐 Python | 📅 2026-09-03 - Official production-ready skill examples and reference implementations.
* [Agent Skills Specification](https://github.com/agentskills/agentskills) ⭐ 25,064 | 🐛 77 | 🌐 Python | 📅 2026-08-09 - Open format and reference documentation for portable agent skill packages.
* [NVIDIA Agent Skills](https://github.com/NVIDIA/skills) ⭐ 3,210 | 🐛 14 | 🌐 Python | 📅 2026-09-05 - NVIDIA-maintained catalog of skills for CUDA-X libraries, blueprints, and platform tools.
...
* [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) ⭐ 130 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-05 - MIT-licensed collection of 71 Claude Code and Codex skills for orchestration, worker fleets, code review, AI evaluation, product, design, and growth workflows.
...
* [Mem0](https://github.com/mem0ai/mem0) ⭐ 64,746 | 🐛 730 | 🌐 Python | 📅 2026-09-04 - Memory layer for AI assistants and agents.
* [LightRAG](https://github.com/HKUDS/LightRAG) ⭐ 39,418 | 🐛 222 | 🌐 Python | 📅 2026-09-05 - Simple and fast RAG framework using graph structures.
* [Khoj](https://github.com/khoj-ai/khoj) ⭐ 37,139 | 🐛 146 | 🌐 Python | 📅 2026-08-02 - Personal AI assistant with long-term memory and knowledge search.
* [GraphRAG](https://github.com/microsoft/graphrag) ⭐ 35,851 | 🐛 45 | 🌐 Python | 📅 2026-09-02 - Graph-based retrieval augmented generation from Microsoft.
* [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,400 | 🐛 703 | 🌐 Rust | 📅 2026-09-05 - High-performance vector search engine for agent memory.
* [Graphiti](https://github.com/getzep/graphiti) ⭐ 30,615 | 🐛 490 | 🌐 Python | 📅 2026-09-04 - Real-time knowledge graph framework for AI agents.
* [Cognee](https://github.com/topoteretes/cognee) ⭐ 30,495 | 🐛 480 | 🌐 Python | 📅 2026-09-05 - Memory management layer for LLM apps using knowledge graphs.
* [Neo4j](https://github.com/neo4j/neo4j) ⭐ 17,193 | 🐛 247 | 🌐 Java | 📅 2026-08-24 - Graph database platform widely used for agent knowledge stores.
* [Weaviate](https://github.com/weaviate/weaviate) ⭐ 16,785 | 🐛 718 | 🌐 Go | 📅 2026-09-05 - Vector database with built-in modules for AI workloads.
* [txtai](https://github.com/neuml/txtai) ⭐ 12,927 | 🐛 7 | 🌐 Python | 📅 2026-09-04 - All-in-one embeddings database for semantic search and workflows.
* [FalkorDB](https://github.com/FalkorDB/FalkorDB) ⭐ 5,902 | 🐛 673 | 🌐 Rust | 📅 2026-09-05 - Ultra-fast graph database for AI agent knowledge.
...
* [Memgraph](https://github.com/memgraph/memgraph) ⭐ 4,391 | 🐛 813 | 🌐 C++ | 📅 2026-09-05 - In-memory graph database for real-time agent queries.
* [ReMe](https://github.com/agentscope-ai/ReMe) ⭐ 3,415 | 🐛 26 | 🌐 Python | 📅 2026-09-04 - Local-first agent memory layer with editable Markdown storage and hybrid retrieval.
...
* [Anchor](https://github.com/solana-foundation/anchor) ⭐ 5,127 | 🐛 129 | 🌐 Rust | 📅 2026-09-05 - Core Solana framework for building and integrating smart contracts and clients.
* [Solana Web3.js](https://github.com/solana-foundation/solana-web3.js) ⭐ 2,752 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-05 - JavaScript SDK for interacting with the Solana blockchain.
* [LangChain Solana Agent Kit](https://github.com/sendaifun/solana-agent-kit) ⭐ 1,710 | 🐛 66 | 🌐 TypeScript | 📅 2026-05-14 - LangChain tools for Solana agent operations.
* [Solana Agent Kit](https://github.com/sendaifun/solana-agent-kit) ⭐ 1,710 | 🐛 66 | 🌐 TypeScript | 📅 2026-05-14 - Toolkit for connecting AI agents to Solana protocols.
...
* [Jito-Solana](https://github.com/jito-foundation/jito-solana) ⭐ 746 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - MEV-aware Solana client infrastructure for advanced execution agents.
...
* [Pyth Crosschain](https://github.com/pyth-network/pyth-crosschain) ⭐ 247 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-05 - Oracle infrastructure for low-latency market data used by agent strategies.
...
* [Solana Agent Identity](https://github.com/sendaifun/solana-agent-kit) ⭐ 1,710 | 🐛 66 | 🌐 TypeScript | 📅 2026-05-14 - Agent wallet and identity features in Solana Agent Kit.
* [Coinbase AgentKit](https://github.com/coinbase/agentkit) ⭐ 1,297 | 🐛 362 | 🌐 TypeScript | 📅 2026-09-03 - Toolkit for giving AI agents programmable wallet capabilities.
...
* [Awesome Agentic Commerce](https://github.com/Merit-Systems/awesome-agentic-commerce) ⭐ 147 | 🐛 257 | 📅 2026-07-29 - Curated directory of agent payments and commerce protocols, including x402.
...
* [ElizaOS DeFi Plugins](https://github.com/elizaOS/eliza/tree/main/packages) ⭐ 19,258 | 🐛 1,334 | 🌐 TypeScript | 📅 2026-09-05 - DeFi protocol integrations for ElizaOS agents.
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 102,611 | 🐛 363 | 🌐 Python | 📅 2026-09-01 - Multi-agent LLM framework simulating a trading firm.
* [Freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,048 | 🐛 31 | 🌐 Python | 📅 2026-09-05 - Open-source algorithmic trading bot in Python.
* [Qlib](https://github.com/microsoft/qlib) ⭐ 48,321 | 🐛 472 | 🌐 Python | 📅 2026-09-02 - AI-oriented quantitative investment platform from Microsoft.
* [NautilusTrader](https://github.com/nautechsystems/nautilus_trader) ⭐ 28,410 | 🐛 127 | 🌐 Rust | 📅 2026-09-05 - High-performance algorithmic trading platform in Rust and Python.
* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,491 | 🐛 260 | 🌐 C# | 📅 2026-09-05 - Algorithmic trading engine by QuantConnect.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 21,210 | 🐛 84 | 🌐 Jupyter Notebook | 📅 2026-09-03 - Open-source financial LLM framework.
* [Hummingbot](https://github.com/hummingbot/hummingbot) ⭐ 19,849 | 🐛 156 | 🌐 Python | 📅 2026-09-05 - Open-source market making and arbitrage bot.
* [FinRL](https://github.com/AI4Finance-Foundation/FinRL) ⭐ 16,221 | 🐛 310 | 🌐 Jupyter Notebook | 📅 2026-07-13 - Deep reinforcement learning library for quantitative finance.
* [VectorBT](https://github.com/polakowo/vectorbt) ⭐ 9,002 | 🐛 140 | 🌐 Python | 📅 2026-08-02 - Fast backtesting and analysis library for trading strategies.
...
* [LiteLLM](https://github.com/BerriAI/litellm) ⭐ 58,115 | 🐛 4,893 | 🌐 Python | 📅 2026-09-05 - LLM gateway and proxy with logging, cost tracking, and routing controls.
* [LangFuse](https://github.com/langfuse/langfuse) ⭐ 34,234 | 🐛 908 | 🌐 TypeScript | 📅 2026-09-05 - Open-source LLM engineering platform for tracing and evaluation.
* [SigNoz](https://github.com/SigNoz/signoz) ⭐ 32,019 | 🐛 1,540 | 🌐 TypeScript | 📅 2026-09-05 - OpenTelemetry-native observability platform for traces, logs, and metrics.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,814 | 🐛 260 | 🌐 Python | 📅 2026-09-05 - Open-source platform for LLM and agent tracing, evaluation, and monitoring.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,390 | 🐛 332 | 🌐 Python | 📅 2026-04-14 - Framework and benchmark registry for evaluating LLM systems.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 18,118 | 🐛 565 | 🌐 Python | 📅 2026-09-03 - Open-source LLM evaluation framework.
* [Portkey](https://github.com/Portkey-AI/gateway) ⭐ 12,904 | 🐛 258 | 🌐 TypeScript | 📅 2026-05-25 - AI gateway with observability, caching, and fallback routing.
* [Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,340 | 🐛 976 | 🌐 Python | 📅 2026-09-05 - Open-source AI observability platform from Arize.
...
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,133 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-31 - Open-source LLM observability and monitoring platform.
...
* [Weave](https://github.com/wandb/weave) ⭐ 1,125 | 🐛 221 | 🌐 Python | 📅 2026-09-04 - Toolkit for tracking and evaluating LLM applications from W\&B.
* [ax](https://github.com/Necmttn/ax) ⭐ 105 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-05 - Local telemetry, recall, cost, skill, routing, and hook analytics for AI coding agents.
...
* [Awesome AI Agent Papers](https://github.com/VoltAgent/awesome-ai-agent-papers) ⭐ 1,749 | 🐛 0 | 📅 2026-09-05 - Continuously updated collection of agent research papers.
...
For broken links, outdated descriptions, or missing categories, use the repository's structured [issue forms](https://github.com/0xNyk/awesome-agent-cortex/issues/new/choose) ⭐ 216 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-02. [SUPPORT.md](SUPPORT.md) routes broader questions, and [SECURITY.md](SECURITY.md) covers private vulnerability reporting.
